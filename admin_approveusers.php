...
<body>
    ...
    <div class="main">
        <div class="mini-nav">
            <a href="admin_listusers.php"><span>Active Users</span></a>
            <a href="#"><span class="active">Approve Users</span></a>
        </div>
        <div class="user_list">
                    ...
                    <?php if(count($data)>0){ ?>
                        <?php foreach($data as $key=>$record){ ?>    
                            <tr>
                                ...
                                <td class="action">
                                    <a href="user_enable.php?id=<?php echo $record['UserID'] ?>" class="enable" onclick="return confirm('Are you sure to enable the user?')">Enable</a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else {?>
