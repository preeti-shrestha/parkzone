...
<?php
    ...
    $sql="SELECT SlotID,SlotType,SlotStatus,LocationID from slot where slot.LocationID in (Select parklocation.LocationID from parklocation where parklocation.AdminID='$admin_id')";
...
<body>
    ...
    <div class="main">
        <div class="mini-nav">
            <a href="#"><span class="active">Slots List</span></a>
