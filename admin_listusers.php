...
<body>
    ...
    <div class="main">
        <div class="mini-nav">
            <a href="#"><span class="active">Active Users</span></a>
            <a href="admin_approveusers.php"><span>Approve Users</span></a>
        </div>
        <div class="user_list">
            <?php if(isset($_GET['msg']) && $_GET['msg']==3) {?>
                <p class="err_msg">Unable to delete user</p>
            <?php }?>
                    ...
                    <?php if(count($data)>0){ ?>
                        <?php foreach($data as $key=>$record){ ?>    
                            <tr>
                                ...
                                <td><?php echo $record['VehicleType'] ?></td>
                                <td><?php echo $record['BookingStatus'] ?></td>
                                <td class="action">
                                    <a href="user_disable.php?id=<?php echo $record['UserID'] ?>" class="delete" onclick="return confirm('Are you sure to disable the user?')">Disable</a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else {?>
